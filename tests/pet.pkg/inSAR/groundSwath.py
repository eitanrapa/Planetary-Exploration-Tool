...
# Make a ground swath
gs = pet.insar.groundSwath(start_time=times[1], end_time=times[2],
                           time_interval=30, ground_resolution=500, planet=planet, instrument=instrument)
...
# Plot
gs.visualize(projection=projection)
