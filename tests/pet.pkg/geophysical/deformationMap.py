...
deformation_map.visualize(projection=projection, time_point=1482219658.317582, direction="east")

# Visualize displacements
deformation_map.visualize(projection=projection, time_point=1482219658.317582, direction="north")

# Visualize displacements
deformation_map.visualize(projection=projection, time_point=1482219658.317582, direction="up")
