...
with open('/home/user/Documents/GitHub/Planetary-Exploration-Tool/input/acquisition_cadence.json', 'r') as file:
    acquisition_cadence = json.load(file)

# Make an onboard processing object
onboard_processing = pet.simulations.onboardProcessing(planet=planet, conops=conops, acquisition_radius=400/3,
