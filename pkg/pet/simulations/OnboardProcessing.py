...
class OnboardProcessing(pet.component):
    ...
    def extremal_distribution(self, n):
        """
        Returns an extremal type distribution sampling
        :param n: Number of samples
        :return: x, y sampled points
        """
    ...
    def gaussian_distribution(self, n):
        """
        Returns a gaussian type distribution sampling
        :param n: Number of samples
        :return: x, y sampled points
        """
        ...
        # Get random x, y positions based on gaussian sampling
        px = np.random.normal(loc=0, scale=r, size=n)
        py = np.random.normal(loc=0, scale=r, size=n)
        p = np.asarray([px, py]).T
    ...
    def uniform_distribution(self, n):
        """
        Returns a uniform type distribution sampling
        :param n: Number of samples
        :return: x, y sampled points
        """
        ...
        # Get n angles and lengths in the circle
