...
class GroundTarget(pet.component):
    ...
    def point_position_relative_to_satellite(self, satellite_position, satellite_velocity):
        """
    ...
    def get_look_angle(self, satellite_position, shape):
        """
        ...
        distance = get_distance_cartesian(self.x, self.y, self.z, satellite_x, satellite_y, satellite_z)
        ...
        altitude = get_distance_cartesian(self.x, self.y, self.z, 0, 0, 0)
