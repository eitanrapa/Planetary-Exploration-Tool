...
class BiaxialPlanar(pet.component, family="pet.projections.biaxialProjections.biaxialPlanar",
    ...
    def proj(self, planet):
        ...
        fig, ax = plt.subplots(
            subplot_kw={'projection': ccrs.Stereographic(central_latitude=self.central_latitude,
