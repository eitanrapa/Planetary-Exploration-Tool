...
class BiaxialCylindrical(pet.component, family="pet.projections.biaxialProjections.biaxialCylindrical",
    ...
    def proj(self, planet):
        ...
        fig, ax = plt.subplots(subplot_kw={
            'projection': ccrs.LambertCylindrical(central_longitude=self.central_longitude,
                                                  globe=img_globe)})
